      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-12 items-center w-full max-w-7xl">
        ...
        <div className="flex flex-col items-center lg:items-end text-center lg:text-right">
          <h1
            ...
            className=" text-[45px] sm:text-[64px] leading-[1.3] capitalize tracking-wider"
          >
            About Us
          </h1>
          <img src="/leafe.png" loading="lazy" alt="leaf" className="w-[45px] my-4 rotate-180 lg:rotate-0" />
          <p className=" text-neutral-400 text-sm sm:text-base leading-7 max-w-md">
          ...
          <button
            ...
            className="text-black  font-bold text-base hover:text-white px-6 py-2 mt-6 border-none cursor-pointer hover:bg-white transition-colors"
          >
            Order Now
          </button>
        </div>
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <a
            href="#contact"
            style={{ backgroundColor: brandGreen }}
            className="text-black  hover:text-white font-bold text-base px-6 py-2 mt-6 border-none cursor-pointer hover:bg-white transition-colors"
          >
            Find Us
          </a>
        </div>
